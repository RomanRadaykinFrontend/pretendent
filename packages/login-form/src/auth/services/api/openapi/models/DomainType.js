 ...
 */
import { ADFSFromJSONTyped, ADFSToJSON, LDAPFromJSONTyped, LDAPToJSON, } from './';
export function DomainTypeFromJSON(json) {
    return DomainTypeFromJSONTyped(json, false);
}
export function DomainTypeFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...ADFSFromJSONTyped(json, true), ...LDAPFromJSONTyped(json, true) };
}
export function DomainTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return { ...ADFSToJSON(value), ...LDAPToJSON(value) };
}
