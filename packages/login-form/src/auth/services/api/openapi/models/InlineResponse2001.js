 ...
 */
export function InlineResponse2001FromJSON(json) {
    return InlineResponse2001FromJSONTyped(json, false);
}
export function InlineResponse2001FromJSONTyped(json, ignoreDiscriminator) {
...
export function InlineResponse2001ToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
