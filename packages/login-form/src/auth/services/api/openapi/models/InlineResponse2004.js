...
export function InlineResponse2004FromJSON(json) {
    return InlineResponse2004FromJSONTyped(json, false);
}
export function InlineResponse2004FromJSONTyped(json, ignoreDiscriminator) {
...
export function InlineResponse2004ToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
