...
import { addAccessTokenToParams } from '../../helpers/api'

export const BASE_PATH = window.AUTH_API_URL.replace(/\/+$/, "");
...
export class BaseAPI {
    ...
    private createFetchParams(context: RequestOpts) {
        ...
        addAccessTokenToParams(context, this.configuration.accessToken)
