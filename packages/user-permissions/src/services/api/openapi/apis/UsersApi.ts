...
export class UsersApi extends runtime.BaseAPI {
    ...
    /**
     * block user. It will be hidden from user queries and only admin will be able to request it, will not be able to authenticate and all refresh tokens will be invalidated.  Allowed scopes:   - admin
     */
    ...
    /**
     * delete users.  Allowed scopes:   - admin
     */
